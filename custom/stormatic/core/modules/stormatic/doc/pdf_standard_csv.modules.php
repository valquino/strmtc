...
/**
 *  \file       core/modules/stormatic/doc/pdf_standard.modules.php
 *  \ingroup    stormatic
...
/**
 *	Class to manage PDF template standard_csv
 */
class pdf_standard_csv extends ModelePDFCsv
{
	/**
	...
	public function write_file($object, $outputlangs, $srctemplatepath = '', $hidedetails = 0, $hidedesc = 0, $hideref = 0)
	{
		...
		/*
		if (!empty($conf->global->MAIN_GENERATE_CSV_WITH_PICTURE))
		{
		...
		*/
		...
		if ($conf->stormatic->dir_output.'/csv') {
			$object->fetch_thirdparty();

			// Definition of $dir and $file
			if ($object->specimen) {
				$dir = $conf->stormatic->dir_output.'/csv';
				$file = $dir."/SPECIMEN.pdf";
			} else {
				$objectref = dol_sanitizeFileName($object->ref);
				$dir = $conf->stormatic->dir_output.'/csv/'.$objectref;
